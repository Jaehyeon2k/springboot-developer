package me.jhkim.springdeveloper.config.jwt;
...
public class JwtFactory {
    ...
    @Builder
    public JwtFactory(String subject, Date issuedAt, Date expiresAt,
    ...
    public String creatToken(JwtProperties jwtProperties) {
